...
3. Run the code by navigating to the directory and type the following command in the terminal: "python3 asg3.py iris.data k" where k is the number of clusters you want